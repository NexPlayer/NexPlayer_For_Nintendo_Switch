...
<a align=right href="https://nexplayersdk.com/nintendo-player-sdk/" target="_blank"><img src="resources/NexPlayerLogoSwitch.png" width="60%" height="60%" alt="NexPlayer Logo with Nintendo Switch Logo"></a>
  ...
  * **[Contact](#contact)**
  ...
  <br>
  <sub><sup>Unity video player for Switch, Unity video player for Nintendo Switch, Video player for Nintendo Switch game with Unity, Unity video streaming on Nintendo Switch, Video streaming and playback for Switch games with Unity, Video playback for Switch, Video playback on Nintendo Switch, Video Player for Nintendo Switch.</sup></sub>
